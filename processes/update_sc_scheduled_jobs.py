...
def process_sc_scheduled_jobs(services, job_name, status):
  ...
  job_mapping = {
      'hmpps-github-discovery-teams': sc.scheduled_jobs_github_discovery_teams_get,
      'hmpps-github-discovery-full': sc.scheduled_jobs_github_discovery_full_get,
      'hmpps-github-discovery-incremental': sc.scheduled_jobs_github_discovery_incremental_get,
  }
  ...
  if job_name in sc_scheduled_jobs_dict:
    ...
    sc.update(sc.scheduled_jobs, sc_scheduled_job_id, job_data)
  else:
